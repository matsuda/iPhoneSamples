...
//    CGPoint center = CGPointMake(width / 2, height / 2);
    CGPoint center = CGPointMake(CGRectGetMinX(rect), CGRectGetMinY(rect));
    
    CGFloat outerRadius = distanceBetweenPoints(CGPointMake(0, 0), center);
    CGFloat oRadius = distanceBetweenPoints(CGPointMake(0, height), center);
    outerRadius = MAX(outerRadius, oRadius);
    oRadius = distanceBetweenPoints(CGPointMake(width, 0), center);
    outerRadius = MAX(outerRadius, oRadius);
    oRadius = distanceBetweenPoints(CGPointMake(width, height), center);
    outerRadius = MAX(outerRadius, oRadius);
